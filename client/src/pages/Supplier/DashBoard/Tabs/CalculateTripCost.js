  ...
  render() {
    return (
      <div className="p-3">
        ...
        <Row>
          <Col>
            <Form.Label className="font-weight-bold">Driver Cost</Form.Label>
          ...
          <Col>
            <Form.Label className="font-weight-bold">Vechile Cost</Form.Label>
            <small> INR (per hour)</small>
            <Form.Control
              type="number"
              onChange={this.handleChange}
        ...
        <Row>
          <Col>
            ...
            {this.state.fromSuggestionsIsOpen ? (
              <div className="border border-muted mt-1 p-2">
                {this.state.fromSuggestions.slice(0, 4).map((val, index) => {
                  return (
                    <div
          ...
          <Col>
            <Form.Label className="font-weight-bold">Drop Location</Form.Label>
            <Form.Control
              type="text"
              name="dropLocation"
              autoComplete="off"
