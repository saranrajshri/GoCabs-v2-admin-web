...
// Integrate Firebase for driver portal.
    ...
    if (this.state.email !== "" && this.state.password !== "") {
      auth
        ...
        .then(res => {
          ...
          window.location = `${Const.BASE_URL}/driver/home`;
        })
        .catch(err => {
          this.setState({
            ...
            <Col xs={12} md={6} className="border border-muted p-5">
              ...
              <div className="mt-5 m-2 loginForm">
                ...
                <Button
                  ...
                  onClick={this.login}
                >
                  {this.state.loading ? "Loading" : "Login in to driver portal"}
...
//Login context for driver.
//DriverLogin.contextType = FireBaseContext;
